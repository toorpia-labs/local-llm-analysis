#!/usr/bin/env python3
"""
Run 100 MCP trials and save results to file.
"""
...
async def run_100_trials():
    """Run 100 independent MCP trials."""
    ...
    results_file = results_dir / f'results_{timestamp}.dat'
    csv_dir = results_dir / f'hidden_states_{timestamp}'

    logger.info("=" * 60)
    logger.info("100 MCP TRIALS EXPERIMENT - RED COLOR")
...
def main():
    """Main function."""
    return asyncio.run(run_100_trials())
